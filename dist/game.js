...
function renderDeploy(){
 ...
 const troop=TROOPS[selectedTroop]||M.HEROES[selectedTroop]||X.SIEGE[selectedTroop];$('deploy-instruction').textContent=spellMode?'Tap the battlefield to cast '+M.SPELLS[selectedSpell].name:troop?'Tap outside the red border to deploy '+troop.name:'Your army is fighting.';
