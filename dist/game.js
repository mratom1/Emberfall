import {SocialUI} from './social-ui.js?v=17.2.0';
import {modelPortrait,installModelPictures} from './portraits.js?v=17.2.0';
import {VillageUI} from './village-ui.js?v=17.2.0';
import * as R from './raids.js?v=17.2.0';
import {RaidUI} from './raid-ui.js?v=17.2.0';
import {installLandscape} from './viewport.js?v=17.2.0';
import {GRAPHICS,graphicsProfile} from './graphics.js?v=17.2.0';
import {AccountUI} from './account-ui.js?v=17.2.0';
import {nativeApp,chooseServer} from './native.js?v=17.2.0';
import {QualityUI} from './quality-ui.js?v=17.2.0';
import * as M from './model.js?v=17.2.0';
import * as X from './expansion.js?v=17.2.0';
...
import {TYPES,TROOPS,QUESTS,SAVE_KEY,loadState,capacity,armyCapacity,armySize,queueSize,hallLevel,freeBuilders,producerRate,productionCapacity,upgradeCost,canPlace,build,upgrade,train,advance,collect,claimQuest,enemyDef,createBattle,deploy,strike,stepBattle,settleBattle} from './model.js?v=17.2.0';
